...
var Board = function () {
  ...
  _createClass(Board, [{
    ...
    value: function handleClick(x, y) {
      ...
      // console.log(this.stage.getObjectsUnderPoint(x,y,1));
      // debugger
      if (tgt.dh_type === true) {
        console.log("DUCK");
        // console.log(tgt)
...
var UI = function () {
  function UI(stage) {
    ...
    // this.menu_button.dh_btn_callback = this.handleMenu.bind(this)
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  // const loadingStage = new createjs.Stage("demoCanvas")
