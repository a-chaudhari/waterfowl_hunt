...
var Board = function () {
  ...
  _createClass(Board, [{
    ...
    value: function intro() {
      ...
      obj.to({ x: 150 }, 2000).call(this.changeAnimation(this.dog, "sniff")).wait(1000).to({ x: 300 }, 2000).call(this.changeAnimation(this.dog, "sniff")).wait(1000).call(this.changeAnimation(this.dog, "happy")).call(this.playSound("bark", ppc)).wait(500).call(this.changeAnimation(this.dog, "jumping")).to({ x: 350, y: 300 }, 500).call(this.shiftToBehindBackground(this.dog).bind(this)).call(this.changeAnimation(this.dog, "landing")).to({ x: 400, y: 500 }, 500).call(this.gameLoop.bind(this));
      // .to({alpha:0})
      ...
      if (this.birdsLaunched === 10 && this.birdsOnScreen() === 0) {
        ...
        if (this.birdsOnScreen() !== 0 && this.bulletsLeft === 0) {
          ...
          Object.keys(this.activeBirds).forEach(function (bird_key) {
            ...
            _this2.activeBirds[bird_key].flyaway();
          });
    ...
    value: function laughingDog() {
      ...
      var obj = createjs.Tween.get(this.dog);
      obj.wait(2000).call(this.playSound("laugh").bind(this)).to({ y: 375 }, 1000).wait(1000).to({ y: 600 }, 1000).call(this.gameLoop.bind(this));
    }
  }, {
    key: 'birdLived',
    value: function birdLived(id) {
      ...
      return function (e) {
        ...
        _this4.flewAway = true;
        _this4.ui.regMiss();
        _this4.redBackground();
        _this4.ui.showFlewAway();
        _this4.laughingDog();
        // this.ui.flewAway();
        // this.numBirds--;
      };
    ...
    value: function removeBird(id) {
      ...
      return function (e) {
        ...
        _this5.numBirds--;
        _this5.stage.removeChild(_this5.activeBirds[id].duck);
        if (_this5.activeBirds[id].alive) {
          // this.laughingDog();
        } else {
          _this5.happyDog();
        }
        delete _this5.activeBirds[id];
        // this.gameLoop();
      };
    }
  }, {
    ...
    value: function shiftToBehindBackground(obj) {
      ...
      return function (e) {
        ...
        _this6.stage.setChildIndex(obj, _this6.stage.getChildIndex(_this6.background));
      };
    }
  }, {
    key: 'drawDucks',
    value: function drawDucks() {
      ...
      Object.keys(this.activeBirds).forEach(function (key) {
        _this7.activeBirds[key].moveDuck();
      });
      // duck.moveDuck();
    }
  }, {
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  preload.loadManifest([{ id: "intro", src: "/audio/02-duck-hunt-intro.mp3" }, { id: "shot", src: "/audio/shot.mp3" }, { id: "wing_flap", src: "/audio/99-duck-flapping-sfx-.mp3" }, { id: "falling", src: "/audio/falling.mp3" }, { id: "bark", src: "/audio/99-bark-sfx-.mp3" }, { id: "ground_thud", src: "audio/ground_thud.mp3" }, { id: "laugh", src: "/audio/99-laugh-sfx-.mp3" }, { id: "got_one", src: "/audio/04-got-duck-s-.mp3" }
