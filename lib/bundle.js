  ...
  _createClass(Board, [{
    ...
    value: function frameCallback(frame) {
      ...
      if (frame.hands.length > 0) {
        ...
        var indexF = rightH.indexFinger;
        var posF = indexF.stabilizedTipPosition;
        var normF = frame.interactionBox.normalizePoint(posF);
        ...
        var palm = leftH.palmPosition;
        var index = leftH.indexFinger.tipPosition;
        // const dist = Leap.vec3.dist([palm[0],palm[1],0], [index[0],index[1],0]);
        var dist3 = Leap.vec3.dist(palm, index);
        console.log(dist3);
